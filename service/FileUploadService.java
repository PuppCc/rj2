...
import com.easyse.easyse_simple.config.AliyunOssConfig;
import com.easyse.easyse_simple.enums.StatusCode;
...
public class FileUploadService {
     ...
     * 允许上传文件(图片)的格式
     */
    private static final String[] IMAGE_TYPE = new String[]{".bmp", ".jpg", ".txt",
            ".jpeg", ".gif", ".png", ".zip", ".md", ".ppt", ".doc", ".docx", ".pdf"};
     ...
     * @author: zky2002
     */
    public String upload(MultipartFile uploadFile, boolean isDownload) {
        // 获取oss的Bucket名称
...
//        String newFileName = UUID.randomUUID().toString() + fileType;
        ...
        // 文件上传的路径地址
        String uploadImgeUrl = filehost + "/" + filePath + "/" + originalFilename;
        // TODO 名称判断是否已经存在
        // 获取文件输入流
...
//        URL url = ossClient.generatePresignedUrl(aliyunOssConfig.getBucketName()
//                ,aliyunOssConfig.getAccessKeyId(), new Date());
